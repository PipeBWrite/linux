...
enum pageflags {
	...
	PG_scache,		/* Page allocated from StreamCache pool */
#endif
	__NR_PAGEFLAGS,
...
#ifdef CONFIG_SCACHE_MEMORY
PAGEFLAG(Scache, scache, PF_ANY)
#define __PG_SCACHE	(1UL << PG_scache)
#else
PAGEFLAG_FALSE(Scache, scache)
#define __PG_SCACHE	0
#endif
