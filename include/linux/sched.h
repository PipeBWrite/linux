...
# endif
	...
	bool bg_fsync_on;
	atomic_t bg_fsync_count;

	/* BG write_end batching: defer per-entry inode-dirty journaling to
	 * the end of the request (a_ops->bg_batch_begin/end). */
	bool bg_we_defer_dirty;
	bool bg_we_dirty_pending;
