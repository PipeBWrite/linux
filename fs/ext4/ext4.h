...
/*
 * Larger batch for dirty/free cluster percpu counters to reduce cacheline
 * bouncing when many BG threads update concurrently.
 */
#define EXT4_PERCPU_BATCH (percpu_counter_batch * 10)
#else
#define EXT4_FREECLUSTERS_WATERMARK 0
#define EXT4_PERCPU_BATCH percpu_counter_batch
#endif
